...
| Year | Title                                                        |        Venue         |                            Paper                             |                             Code                             |
| ---- | ------------------------------------------------------------ | :------------------: | :----------------------------------------------------------: | :----------------------------------------------------------: |
| 2022 | **Transformer-based Dynamic Fusion Clustering Network (TDCN)** |         KBS          | [Link](https://www.sciencedirect.com/science/article/pii/S0950705122010772) |                              -                               |
...
| 2021 | **Self-supervised heterogeneous graph neural network with co-contrastive learning** | SIGKDD  |    [Link](https://dl.acm.org/doi/10.1145/3447548.3467415)    |         [Link](https://github.com/liun-online/HeCo)          |
...
| 2016 | **Deep Neural Networks for Learning Graph Representations (DNGR)** |   AAAI   |   [Link](https://ojs.aaai.org/index.php/AAAI/article/download/10179/10038)    |      [Link]([https://github.com/karenlatong/AGC-maste](https://github.com/ShelsonCao/DNGR)r)       |
