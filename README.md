...
| Year | Title                                                        |  Venue  |                            Paper                             |                             Code                             |
| ---- | ------------------------------------------------------------ | :-----: | :----------------------------------------------------------: | :----------------------------------------------------------: |
| 2023 | **CONVERT: Contrastive Graph Clustering with Reliable Augmentation**              |  ACM MM   |          [Link](https://arxiv.org/pdf/2308.08963.pdf)             |         [Link](https://github.com/xihongyang1999/CONVERT)                       |
| 2023 | **Attribute Graph Clustering via Learnable Augmentation**              |  arXiv   |          [Link](https://arxiv.org/pdf/2212.03559.pdf)             |         -                       |
| 2023 | **CARL-G: Clustering-Accelerated Representation Learning on Graphs**              |  SIGKDD   |          [Link](https://arxiv.org/pdf/2306.06936.pdf)             |         -                       |
